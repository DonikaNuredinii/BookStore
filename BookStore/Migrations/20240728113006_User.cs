        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BookID = table.Column<int>(type: "int", nullable: false),
                    CategoryID = table.Column<int>(type: "int", nullable: false),
                    // CategoryBookID = table.Column<int>(type: "int", nullable: true)
                    CategoryBookID = table.Column<int>(type: "int")
                    .Annotation("SqlServer:Identity", "1, 1"),  // Set auto-increment
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryBooks", x => x.CategoryBookID);  // Use CategoryBookID as primary key
