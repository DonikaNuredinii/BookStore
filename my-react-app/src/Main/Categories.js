...
const CategoriesF = () => {
  ...
  const imagesArkitekture = require.context("../Images/Arkitekture", false, /\.(png|jpe?g|svg)$/);
  const imagesArt = require.context("../Images/Art", false, /\.(png|jpe?g|svg)$/);
  const imagesArkeologji = require.context("../Images/Arkeologji", false, /\.(png|jpe?g|svg)$/);
  const imagesAnektoda = require.context("../Images/Anektoda", false, /\.(png|jpe?g|svg)$/);
  const imagesBiografi = require.context("../Images/Biografi", false, /\.(png|jpe?g|svg)$/);
  const imagesEkonomi = require.context("../Images/Ekonomi", false, /\.(png|jpe?g|svg)$/);
  const imagesEnciklopedi = require.context("../Images/Enciklopedi", false, /\.(png|jpe?g|svg)$/);
  const imagesFantashkence = require.context("../Images/Fantashkence", false, /\.(png|jpe?g|svg)$/);
  const imagesFilozofi = require.context("../Images/Filozofi", false, /\.(png|jpe?g|svg)$/);
  const imagesGjuhesi = require.context("../Images/Gjuhesi", false, /\.(png|jpe?g|svg)$/);
  const imagesHistori = require.context("../Images/Histori", false, /\.(png|jpe?g|svg)$/);
  const imagesKlasike = require.context("../Images/Klasike", false, /\.(png|jpe?g|svg)$/);
  const imagesKritike = require.context("../Images/Kritike", false, /\.(png|jpe?g|svg)$/);
  const imagesMister = require.context("../Images/Mister", false, /\.(png|jpe?g|svg)$/);
  const imagesMuzik = require.context("../Images/Muzik", false, /\.(png|jpe?g|svg)$/);
  const imagesPoezi = require.context("../Images/Poezi", false, /\.(png|jpe?g|svg)$/);
  const imagesPsikologji = require.context("../Images/Psikologji", false, /\.(png|jpe?g|svg)$/);
  const imagesRomance = require.context("../Images/Romance", false, /\.(png|jpe?g|svg)$/);
  const imagesShkencaNatyore = require.context("../Images/ShkencaNatyore", false, /\.(png|jpe?g|svg)$/);
  const imagesShkencaTeknike= require.context("../Images/ShkencaTeknike", false, /\.(png|jpe?g|svg)$/);
  const imagesShkence = require.context("../Images/Shkence", false, /\.(png|jpe?g|svg)$/);
  const imagesSociologji = require.context("../Images/Sociologji", false, /\.(png|jpe?g|svg)$/);
  const imagesSport = require.context("../Images/Sport", false, /\.(png|jpe?g|svg)$/);
  const imagesTeater = require.context("../Images/Teater", false, /\.(png|jpe?g|svg)$/);
